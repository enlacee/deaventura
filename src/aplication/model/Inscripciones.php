...
class Inscripciones{
    ...
    public function listInscripcionesCuenta(){
        ...
        <div id="steps">
            <div id="titu_step"> <span class="glyphicon glyphicon-calendar"></span> Ventas - <?php echo $Ventas[0]['nombre_actividad'];?> 
                    ...
                    for($i = 0; $i < $nVentas; $i++){  ?>                      
                      <tr>           
                          ...
                          <td>
							...
							<input type="button" style="display:none;margin-top: -25px;margin-left: 70px;" id='cerrar_detalle_<?php echo $Ventas[$i]['id_venta'];?>' value='detalle' onclick="cerrar_menu('<?php echo $Ventas[$i]['id_venta'];?>')" />
                            <input type="button" style="margin-top: -25px;margin-left: 70px;" id='abrir_detalle_<?php echo $Ventas[$i]['id_venta'];?>' value='detalle' onclick="abrir_detalle('<?php echo $Ventas[$i]['id_venta'];?>')" />
