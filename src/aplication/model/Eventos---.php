    ...
    public function newEventos() {
        ...
        <form name="eventos" method="post" action="" enctype="multipart/form-data"> 
            <fieldset id="form">
                ...
                <ul> 
                    <li><label><strong> Titulo : </strong></label><input type="text" name="titulo_evento" id="titulo_evento" value="" size="59" maxlength="50"><em>* Solo números y letras</em></li> 
                    <li><label><strong> Lugar : </strong></label><input type="text" name="lugar_evento" value="" size="59" maxlength="45"></li> 
...
//            ?>
    ...
    public function addEventos() {
        ...
        $sql = "INSERT INTO eventos(id_cliente,titulo_evento, fecha_evento, lugar_evento, descripcion_evento, image,tags) 
                VALUES (null,
    ...
    public function editEventos() {
        ...
        <fieldset id="form">
            ...
            <form name="eventos" method="post" action="" enctype="multipart/form-data"> 
                ...
                <ul> 
                    <li><label><strong> Titulo : </strong></label><input type="text" name="titulo_evento" id="titulo_evento" value="<?php echo sql_htm($row['titulo_evento']) ?>" size="59" maxlength="50"><em>* Solo números y letras</em></li> 
                    <li><label><strong> Lugar : </strong></label><input type="text" name="lugar_evento" value="<?php echo $row['lugar_evento'] ?>" size="59" maxlength="45"></li> 
...
//        ?>
    ...
    public function listEventos() {
        ...
        <div id="content-area">
            ...
            <ul id="listadoul">
                <?php
                $sql = "SELECT * FROM eventos ORDER BY fecha_evento DESC limit 100";
                $query = new Consulta($sql);
                $y = 1;
                while ($rowp = $query->VerRegistro()) {
                    ?>
   ...
   public function neweventos_cuenta(){
    ...
    public function miseventos_cuenta(Cliente $cliente){
		...
		?>
        <div id="steps">
            <div id="titu_step"> <span class="glyphicon glyphicon-calendar"></span> Mis Actividades <a class="btn btn_nuevo" href="cuenta.php?cuenta=miseventos&action=new" title="Nuevo Evento">Nuevo Evento</a></div>
            <div id="panel_step">
