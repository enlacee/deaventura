            ...
            function crearFila() {                
                ...
                select += '</select>'; 
                    ...
                    $('#tabla_solicitud_viatico tbody').append(  
                            ...
                            '<tr>' +                                                      
                            '<td><div class="col-xs-12"><input type="text" class="form-control empresa" name="nombre_tarifa[]" placeholder="Todo incluido" ></div></td>' +
                            '<td><div class="col-xs-12"><input type="text" class="form-control monto" name="precio_tarifa[]" placeholder="00.00" ></div></td>' +
                            '<td><div class="col-xs-12">'+ select +'</div></td>' +  
                            '<td><div class="col-xs-12">'+ select_estado +'</div></td>' +      
                            '</tr>'
                            ); 
            }                                 
                ...
                <?php 
                    for($i = 0; $i < $nsalidas; $i++){
                      ...
                      <tr>
                        ...
                        <td><?php echo $salidas[$i]['titulo'];?> <a href="<?php echo $link;?>" target="_blank" class="href"><img src="aplication/webroot/imgs/icon_mas.jpg" /></a></td>    
                        <td>
                            <a href="cuenta.php?actividades=salidas&action=inscritos&id=<?php echo $salidas[$i]['id_salida']?>" class="btn-circle btn-registro glyphicon glyphicon-th-list" title="Inscritos"> </a>                       
                            <a href="cuenta.php?actividades=salidas&action=edit&id=<?php echo $salidas[$i]['id_salida']?>" class="btn-circle btn-edit glyphicon glyphicon-pencil" title="Editar"> </a>
