...
//        ?>
    ...
    public function getSalidasCuenta($id_cliente){
        $sql = "SELECT id_actividad_salida, nombre_actividad, estado_actividad,fecha_actividad,
            ...
            <div id="panel_step">
                ...
                <section  style="display:inline-block; width:67%; padding-top:10px; padding-left:10px ">
                    ...
                    <div class="form-group" >
                        ...
                        <!--
                        <div class="col-xs-4">
                            <input name="fecha_salida" id="fecha_salida" class="date hasDatepicker" type="text" size="15" style="width:150px;" value="<?php echo implode("-",array_reverse(explode("-",$data->_fecha_salida)));?>">&nbsp;&nbsp;<img src="aplication/webroot/imgs/icon_cal2.png"/></div>
                        </div>
                        -->
                    </div> 
...
Que Llevar:
    ...
    public function addSalidasCuenta(Cliente $cliente){
        ...
        */
        ...
        $query3 = new Consulta($sql3);
        //echo $sql3; 
        $sql4 = "INSERT INTO tarifas(id_actividad,nombre_tarifa,precio_tarifa,comision_porcentual_tarifa) VALUES('". $id_actividad ."','". $_POST['nombre_tarifa'] ."','". $_POST['precio_tarifa'] ."','". $_POST['comision_tarifa'] ."')";
        //echo $sql4; 
    ...
    public function editSalidasCuenta(){
        ...
        //echo br2nl($data->getPadre('_descripcion'));   
        //echo $data->getPadre('_descripcion'); 
       //echo $data->__get('_id_salida');
       //echo $data->__get('_cupos');
       //echo $data->__get('_id_actividad');
       //echo $data['_id_salida'];
        //echo $data->getPadre('_nombre');
        //echo $data->getPadre('_id_deporte');
       /*
        ...
        */
        ...
        <div id="steps">
            <div id="titu_step"> <span class="glyphicon glyphicon-calendar"></span>Editar Evento <a class="btn btn_nuevo" href="cuenta.php?actividades=salidas" title="Nuevo Evento">Regresar</a></div>
            <div id="panel_step">
                ...
                <form action="cuenta.php?actividades=salidas&action=update&id=<?php echo $data->_id_salida;?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" name="form_datos" id="form_datos" onsubmit="return validate2(this, 'update')">
                    ...
                    <div id="div_input1">
                        ...
                        <div class="rowElem"><label>Tags:</label><input name="tagsd" id="tagsd" type="text" size="80" value="<?php echo $data->getPadre('_tags');?>"  /> <i>(caminatas, carreras, trekking)</i></div>
                        <div class="rowElem">
...
*/
            ...
            $query = new Consulta("UPDATE actividades SET 
                                    ...
                                    descripcion_actividad='" . $_POST['descripcion_salida'] . "',
                                    fecha_actividad='" . $fecha . "',
                                    lugar_actividad='" . $_POST['lugar_salida'] . "',
    ...
    public function deleteSalidasCuenta(Cliente $cliente) {   
        ...
        $query2 = new Consulta("DELETE FROM actividades_salidas WHERE id_actividad_salida = '" . $_GET['id'] . "' ");
